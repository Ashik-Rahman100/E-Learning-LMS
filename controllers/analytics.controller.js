...
const getCourseAnalytics = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getOrdersAnalytics = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
